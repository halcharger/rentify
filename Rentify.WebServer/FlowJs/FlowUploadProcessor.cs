...
namespace Rentify.WebServer.FlowJs
{

    public interface IFlowUploadProcessor
    {
        Task<bool> ProcessUploadChunkRequest(HttpRequestMessage request);
        bool IsComplete { get; }
    ...
    public class FlowUploadProcessor : IFlowUploadProcessor
    {
        ...
        protected FlowMetaData MetaData
        {
            get { return this.StreamProvider.MetaData; }
        }

        protected string UploadPath { get; private set; }

        public bool IsComplete { get; private set; }

        public DateTime CompletedDateTime { get; private set; }

        public FlowUploadProcessor() : this("~/App_Data/Tmp/FileUploads") {}
        public FlowUploadProcessor(string uploadPath)
        {
            StreamProvider = GetMultipartProvider(uploadPath);
            UploadPath = StreamProvider.UploadPath;
        }
